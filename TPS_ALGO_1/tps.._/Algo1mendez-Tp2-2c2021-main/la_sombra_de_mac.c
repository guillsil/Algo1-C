...
/*
*   El procedimiento recibe un juego_t y el número de nivel e inicializa el vector de obstáculos
*   de cada nivel por separado
*/
void inicializar_obstaculos(juego_t* juego, int numero_nivel){
    if (numero_nivel == 0){        
        rellenar_vector_obstaculos(juego, VELAS_LVL1, POZOS_LVL1, INTERRUPTORES_LVL1, PORTALES_LVL1, numero_nivel);
    }else if (numero_nivel == 1){
        rellenar_vector_obstaculos(juego, VELAS_LVL2, POZOS_LVL2, INTERRUPTORES_LVL2, PORTALES_LVL2, numero_nivel);
    }else {
        rellenar_vector_obstaculos(juego, VELAS_LVL3, POZOS_LVL3, INTERRUPTORES_LVL3, PORTALES_LVL3, numero_nivel);
    }
}
...
/*
*   El procedimiento recibe un juego_t y el número de nivel e inicializa el vector de herramientas
*   de cada nivel por separado
*/
void inicializar_herramientas(juego_t* juego, int numero_nivel){
    if (numero_nivel == 0){
        rellenar_vector_herramientas(juego, ESCALERAS_LVL1, MONEDAS_LVL1, LLAVES_LVL1, PUERTAS_LVL123, numero_nivel);
    }else if (numero_nivel == 1){
        rellenar_vector_herramientas(juego, ESCALERAS_LVL2Y3, MONEDAS_LVL2Y3, LLAVES_LVL2Y3, PUERTAS_LVL123, numero_nivel);
    }else {
        rellenar_vector_herramientas(juego, ESCALERAS_LVL2Y3, MONEDAS_LVL2Y3, LLAVES_LVL2Y3, PUERTAS_LVL123, numero_nivel);
    }
}
...
/*
*   El procedimiento recibe un juego_t e inicializa los niveles
*/
void inicializar_niveles(juego_t* juego){
    ...
    while(i < MAX_NIVELES){
        ...
        inicializar_obstaculos(juego, (*juego).niveles[i].numero_nivel);
        inicializar_herramientas(juego, (*juego).niveles[i].numero_nivel);
...
/* 
*   Inicializará el juego, cargando toda la información inicial, los datos del personaje y la sombra, y los 3 niveles.
*/
